...
if not st.session_state.user_data:
    ...
    st.stop()  # DETIENE LA EJECUCIÓN AQUÍ. Carga la pantalla de bienvenida en milisegundos.
...
# ------------------------------------------------------------------
# Función con Cache Optimizado (Carga en segundo plano únicamente cuando se requiere)
# ------------------------------------------------------------------
...
if st.button("Enviar") and question:
    with st.spinner("Blink está pensando..."):
        # Se compila o recupera el grafo de caché solo al enviar la pregunta
