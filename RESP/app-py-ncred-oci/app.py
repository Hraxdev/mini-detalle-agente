...
# ==================================================================
# BLOQUE 1: PANTALLA DE BIENVENIDA (Solo si NO se ha iniciado sesión)
# ==================================================================
if st.session_state.user_data is None:
    ...
    input_nombre = st.text_input("¿Cómo te gusta que te llamen?", placeholder="Ej. Carlos Mendoza", key="login_nombre")
    input_email = st.text_input("Tu correo electrónico:", placeholder="ejemplo@correo.com", key="login_email")
...
# ==================================================================
# BLOQUE 2: INTERFAZ DE CHAT (Solo si YA se inició sesión)
# ==================================================================
else:
    # Menú lateral
    with st.sidebar:
